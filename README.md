...
This codebase is preparing for multi-tenant evolution by establishing a foundational tenant model, but it does not yet enforce tenant isolation across all commerce entities. The current implementation lacks several key features, including:

- Real tenant isolation across products, carts, orders, customers, and the admin interface
- Tenant provisioning flow
- Billing
- Custom storefront design
- Production deployment setup
- Search, background jobs, observability, and production hardening

The next evolutionary step involves mapping tenant ownership onto commerce entities and determining the tenant isolation strategy. Isolation can be enforced at one of the following levels:
